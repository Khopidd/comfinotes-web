<x-auth-layout>
    ...
    <div class="container-verif">
        <div class="head-logo-verif">
            <img src="{{ asset('asset/image/logo-2.png') }}" alt="Logo">
        </div>
        <div class="form-section-verif">
            <div class="form-manage-verif">
                <div class="form-image-verif">
                    <img src="{{ asset('asset/image/icon-1.png') }}" alt="icon-verif" class="icon-1">
                </div>
                ...
                <div class="label-button-verif">
                    <a href="{{ route('auth') }}" class="btn-continue">Back to Sign In</a>
